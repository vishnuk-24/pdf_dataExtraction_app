...
class Get_attribute:
    """Get_attribute for getting data from text files."""
    ...
    def process1(self):
        ...
        print(
            'inside prcess1', self.text_file
        )
        try:
            with open(self.text_file, 'rt') as filename:
            ...
            data_process = True
            return {"data_process": data_process, "data": {'name': name, 'title': program, 'date': date,
                    'attendance_ethics_and_professionalism': attendence_ethics_and_professionalism,
                    'attendance_skills': attendence_skill, 'attendance_area_of_professional_practice': attendence_area_of_practice,
                    'attendance_law_practice_management': attendence_law_practice,
                    'faculty_ethics_and_professionalism': faculty_ethics_professionalism,
                    'faculty_skills': faculty_skills, 'faculty_area_of_professional_practice': faculty_area_of_pratice,
                    'faculty_law_practice_management': faculty_law_practice, 'organization': provider}}
        except Exception as e:
            print("Error in process1", e)
            data_process = False
            return {"data_process": data_process, "data": None}

    def process2(self):
        """
        Extract attribute from textfile. pdf - 1346563CLE-NY219141_100266.pdf,
        1346563CLE-NY251620_251619_786259.pdf
        """
        global data_process
        print(
            'inside prcess2', self.text_file
        )
        try:
            with open(self.text_file, 'rt') as filename:
                lines = filename.readlines()
            ...
            data_process = True
            return {"data_process": data_process, "data": {'name': name, 'title': title_program, 'date': date,
                    'attendance_ethics_and_professionalism': attendance_ethics_and_professionalism,
                    'attendance_skills': attendance_skills, 'attendance_area_of_professional_practice': attendance_law,
                    'attendance_law_practice_management': attendance_professional_pratice,
                    'faculty_ethics_and_professionalism': faculty_ethics_and_professionalism,
                    'faculty_skills': faculty_skills, 'faculty_area_of_professional_practice': faculty_law,
                    'faculty_law_practice_management': faculty_professional_pratice, 'organization': provider}}
        except Exception as e:
            print("Error in process2", e)
            data_process = False
            return {"data_process": data_process, "data": None}
                ...
                for index, line in enumerate(lines):
                    ...
                    if 'Areas of Professional Practice\n' in line:
                        ...
                        if area_list:
                            ...
                            faculty_law = None
            data_process = True
            return {"data_process": data_process, "data": {'name': name, 'title': title, 'date': date,
                    'attendance_ethics_and_professionalism': attendance_ethics_and_professionalism,
                    'attendance_skills': None, 'attendance_area_of_professional_practice': attendance_law,
                    'attendance_law_practice_management': attendance_professional_pratice,
                    'faculty_ethics_and_professionalism': faculty_ethics_and_professionalism,
                    'faculty_skills': faculty_skills, 'faculty_area_of_professional_practice': faculty_law,
                    'faculty_law_practice_management': faculty_professional_pratice, 'organization': provider}}
